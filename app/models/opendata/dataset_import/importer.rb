...
module Opendata::DatasetImport
  class Importer
    ...
    include Opendata::Addon::DatasetImport::Report
    include Cms::Addon::GroupPermission
    include ActiveSupport::NumberHelper

    store_in collection: 'opendata_dataset_importers'
    ...
    has_many :reports, class_name: 'Opendata::DatasetImport::Report', dependent: :destroy, inverse_of: :importer
